...
public class PermissionController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "권한 정보가 존재하지 않음"),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "권한 생성 대상이 존재하지 않음"),
            @ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @PostMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "수정 대상 권한이 존재하지 않음"),
            @ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @PatchMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "삭제 대상 권한이 존재하지 않음"),
            @ApiResponse(responseCode = "500", description = "서버 오류")
    })
    @DeleteMapping
