...
public class MemberPermissionController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = """
                    ...
                    - COMMON:4003: familyId 또는 lineId 타입이 올바르지 않습니다.
                    - COMMON:4004: familyId 또는 lineId가 누락되었습니다.
                    """),
            @ApiResponse(responseCode = "403", description = """
                    권한 없음
    ...
    @Operation(summary = "구성원 권한 변경", description = "가족관리자 또는 관리자가 familyId를 기준으로 여러 구성원의 권한을 한 번에 변경한다. 적용 버튼 클릭 시 사용한다.")
    @ApiResponses({
