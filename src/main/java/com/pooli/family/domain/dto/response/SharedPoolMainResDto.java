...
public class SharedPoolMainResDto {
    ...
    @Schema(description = "당월 공유풀 기본 충전량(Byte)", example = "20000")
    private Long sharedPoolBaseData;

    @Schema(description = "당월 공유풀 추가 충전량(Byte)", example = "5000")
    private Long sharedPoolAdditionalData;

    @Schema(description = "당월 공유풀 잔여량(Byte)", example = "12000")
    private Long sharedPoolRemainingData;

    @Schema(description = "당월 공유풀 총량(Byte)", example = "25000")
