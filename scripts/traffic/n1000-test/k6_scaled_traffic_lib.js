...
const LINE_START = 1;
const LINE_END = 1000;
const SPEED_GROUP_LINE_START = 761;
const SPEED_GROUP_LINE_END = 880;
...
const GROUPS = [
  { name: 'G1_NO_RESTRICTION', lineStart: 1, lineEnd: 200, appId: 1 },
  { name: 'G2_LINE_DAILY_20MB', lineStart: 201, lineEnd: 400, appId: 1 },
  { name: 'G3_APP2_DAILY_5MB', lineStart: 401, lineEnd: 600, appId: 2 },
  { name: 'G4_SHARED_ONLY_APP3', lineStart: 601, lineEnd: 760, appId: 3 },
  { name: 'G5_APP2_SPEED_1MBPS', lineStart: 761, lineEnd: 880, appId: 2 },
  { name: 'G6_APP4_DAILY_8MB', lineStart: 881, lineEnd: 1000, appId: 4 },
];
...
export function buildBurstStressScenario1000() {
  const scenarioName = 'BURST_STRESS_1000';

  const options = {
    scenarios: {
      traffic_policy_burst_1000: {
...
export function buildSpeedExactScenario1000() {
  const scenarioName = 'SPEED_EXACT_1000';

  const options = {
    scenarios: {
      traffic_speed_exact_1000: {
        executor: 'per-vu-iterations',
